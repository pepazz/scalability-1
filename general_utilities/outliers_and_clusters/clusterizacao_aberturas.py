...
def clusterizacao_aberturas(df_completo,  # data_frame formatado completo
    ...
    if flag_clusterizacao:
      ...
      if len(df_filtrado[col_data].unique()) < 2:
        ...
        # Vamos gerar uma base sem as aberturas ruins par realizar a clusterização:
        ...
        df_clusters_final_formatado = df_clusters_final_formatado.melt(id_vars=aberturas+['clusters','outlier'],var_name='Etapa', value_name='%__Volume Aberta')
