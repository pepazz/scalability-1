...
def aplica_teste(df_completo,      # DataFrame filtrado na etapa e abertura
  ...
  if etapa.split('2')[0] in topo and tipo_de_tof != 'Input Externo' and tipo_de_tof != 'AG - Somente Cohort Aberta':
